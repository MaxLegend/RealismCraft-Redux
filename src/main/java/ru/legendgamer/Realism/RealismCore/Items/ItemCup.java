            ...
            else
            {
                if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK)
                {
                    ...
                    if (worldIn.getBlockState(blockpos).getMaterial() == Material.WATER)
                    {
                        ...
                        return new ActionResult(EnumActionResult.SUCCESS, this.turnBottleIntoItem(itemstack, playerIn, PotionUtils.addPotionToItemStack(new ItemStack(Items.STICK), PotionTypes.WATER)));
                    }
                }
