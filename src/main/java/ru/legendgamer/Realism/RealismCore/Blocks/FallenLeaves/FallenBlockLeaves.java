package ru.legendgamer.Realism.RealismCore.Blocks.FallenLeaves;
...
{
    public FallenBlockLeaves(Material materialIn, String name, float hardness, float resistanse, SoundType soundtype) {
