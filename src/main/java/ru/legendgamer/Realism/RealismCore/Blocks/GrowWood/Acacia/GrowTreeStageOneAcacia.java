package ru.legendgamer.Realism.RealismCore.Blocks.GrowWood.Acacia;
...
public class GrowTreeStageOneAcacia extends BasicBlockWithCustomModel {
	...
	public void updateTick(World world, BlockPos pos, IBlockState state, Random rand) {
		...
		if(!world.isRemote) {
			if (time2.time == 60) {
				setBlock(new BlockPos(pos.getX(), pos.getY(), pos.getZ()), RegBlocks.growtreetwo.getDefaultState());
			}		
		}
	}
