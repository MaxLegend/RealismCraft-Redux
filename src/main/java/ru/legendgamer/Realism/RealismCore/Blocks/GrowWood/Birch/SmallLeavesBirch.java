...
public class SmallLeavesBirch extends BasicBlockWithCustomModel{
	...
	public SmallLeavesBirch(Material materialIn, String name, float hardness,
	...
	public void updateTick(World world, BlockPos pos, IBlockState state, Random rand) {
		...
		if(!world.isRemote) {
			...
			if (time2.time == 20) {
				world.setBlockState(new BlockPos(pos.getX(), pos.getY(), pos.getZ()), Blocks.LEAVES.getDefaultState().withProperty(BlockOldLeaf.VARIANT, BlockPlanks.EnumType.BIRCH));
			}		
