...
public class WetRedSand extends Block{
	...
	public WetRedSand(final Material materialIn, final String name, float hardness,float resistanse, SoundType soundtype) {
		super(materialIn);
	...
	public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
		...
		if(world.isDaytime() && !world.isRaining() && random.nextInt(160) == 3) {
			world.setBlockState(new BlockPos(pos.getX(), pos.getY(), pos.getZ()),RegBlocks.realismredsand.getDefaultState());
		}
