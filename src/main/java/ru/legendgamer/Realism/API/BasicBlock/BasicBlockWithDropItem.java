...
public class BasicBlockWithDropItem extends BasicBlock {
	...
	public BasicBlockWithDropItem(final Material materialIn, final String name,float hardness, float resistanse,SoundType soundtype, Item drop, int valueDrops, int meta) {
