 ...
 *
 */
public abstract class TileEntityBasic extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public ItemStack decrStackSize(int index, int count) {
    	//Метод "получить и расщепить". Т.е получить слот(и соотв. че там лежит) и забрать оттуда %count% чего то
